...
`;
  ...
  function populateData() {
    ...
    // Finally fetch the CARR and update the row
  ...
  //-----------------------------------------------------------
  // 10) Main MultiTool Beast Initialization
  //-----------------------------------------------------------
  function initTool() {
    ...
    // Insert slider style for sun/moon
...
`;
  ...
  //-----------------------------------------------------------
  // Auto-update on URL change (no reload)
  //-----------------------------------------------------------
  setInterval(() => {
