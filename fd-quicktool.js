...
// @version      1.20
// @description  Appends a sticky, draggable menu to Freshdesk pages with ticket info, copy buttons, recent tickets (last 7 days), and a night mode toggle. Attempts multiple fallbacks (including Ember view lookup) to extract custom field values.
...
(function() {
    ...
    function getFieldValue(inputElement) {
      ...
      // If still empty and Ember is available, try to look up the Ember view.
    ...
    function initTool() {
      ...
      // Delay reading custom fields to allow Ember to finish rendering.
      setTimeout(() => {
      ...
      // Append the menu to document.body (sticky at bottom-right)
